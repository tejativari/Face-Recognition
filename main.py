...
def contact():
    mess._show(title='Contact me', message="Please contact me on : 'chandrasekar@arigs.com' ")
...
lbl2 = tk.Label(frame2, text="Enter Name",width=20  ,fg="black"  ,bg="#ccccff" ,font=('comic', 17, ' bold '))
lbl2.place(x=80, y=140)

txt2 = tk.Entry(frame2,width=32 ,fg="black",font=('comic', 15, ' bold ')  )
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)Take Student Images  >>>  2)Save Profile" ,bg="#ccccff" ,fg="black"  ,width=39 ,height=1, activebackground = "#3ffc00" ,font=('comic', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="" ,bg="#c79cff" ,fg="black"  ,width=39,height=1, activebackground = "#3ffc00" ,font=('comic', 16, ' bold '))
message.place(x=7, y=450)

lbl3 = tk.Label(frame1, text="Attendance",width=20  ,fg="black"  ,bg="#ccccff"  ,height=1 ,font=('comic', 17, ' bold '))
...
clearButton = tk.Button(frame2, text="Clear", command=clear  ,fg="black"  ,bg="#ff2400"  ,width=11 ,activebackground = "white" ,font=('comic', 11, ' bold '))
clearButton.place(x=335, y=86)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2  ,fg="black"  ,bg="#ff2400"  ,width=11 , activebackground = "white" ,font=('comic', 11, ' bold '))
...
quitWindow = tk.Button(frame1, text="Quit", command=window.destroy  ,fg="black"  ,bg="#f70d18"  ,width=35 ,height=1, activebackground = "white" ,font=('comic', 15, ' bold '))
